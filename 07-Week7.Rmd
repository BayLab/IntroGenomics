...
For `pophelper()` you will need to install dependencies first with `install.packages(c("ggplot2","gridExtra","label.switching","tidyr","remotes"),repos="https://cloud.r-project.org")` then install pophelper `remotes::install_github('royfrancis/pophelper')`. This might take a while!
