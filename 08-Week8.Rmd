...
We then need to connect our metadata and our PCA data together. Sample ID in both datasets match, so let's match them up with that!

```{r, echo=T}
tab$Sample_ID <- metadata$Sample_ID
```
...
Turn in your code for how you made your PCAs, how you added region to your metadata file and the three PCAs for question 1 and one PCA for question 2 on canvas.
