...
The main drop off in the graph is around 5 or less, suggesting that those axes explain most of the variation. However let's include PCs 1 through 10 to explore the data more in depth.
