...
[here](https://github.com/ecalfee/STEMinist_R.git). The lecture slides to introduce R more in depth are here: SLIDES
...
with `data(iris)` and submit code and answers for the following questions:
