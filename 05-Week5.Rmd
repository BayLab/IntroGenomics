...
First let's navigate to our R studio on Farm OnDemand! After we start it up we will want to create a new file called "Week5-IntroR.R" to type our scripts for today. Slides for this week are found here: X
