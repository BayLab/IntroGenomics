...
Change directories so that you are inside the week4 directory inside your individual directory.  If you `ls` into this directory you should see 6 files with a `.fastq.gz` extension and 1 tiny genome file with a `.fna.gz` extension.
...
```
How do the alignments compare to the trimmed ones we just did as a class? The full genome and full read files should have a much higher mapping rate (70-80%) than our subset. 
