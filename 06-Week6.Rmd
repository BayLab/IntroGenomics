...
str(ToothGrowth)
#you can also open your dataset with this command which pulls it into a different window
View(ToothGrowth)
```
...
Now let's look at the `msleep` dataset again and make a plot of total sleep against REM sleep and then group by "vore".
